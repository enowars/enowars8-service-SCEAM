...
class UserInputParser():
    ...
    def handle_hmac_hash(self):
        ...
        hash_alg = ['MD5', 'SHA1', 'SHA224', 'SHA256', 'SHA384', 'SHA3_224', 'SHA3_256', 'SHA3_384', 'SHA3_512', 'SHA512', 'SHA512_224', 'SHA512_256', 'SHAKE128', 'SHAKE256', 'SM3']
    ...
    def handle_key_cert_algorithm(self):
        ...
        if input == 'pkcs12.PBES.PBESv1SHA1And3KeyTripleDESCBC':
            self.builder = self.builder.key_cert_algorithm(pkcs12.PBES.PBESv1SHA1And3KeyTripleDESCBC)
            
        elif input == 'pkcs12.PBES.PBESv2SHA256AndAES256CBC':
            self.builder = self.builder.key_cert_algorithm(pkcs12.PBES.PBESv2SHA256AndAES256CBC)
